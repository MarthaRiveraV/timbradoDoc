...
El método *timbrado* recibe el XML de un Comprobante Fiscal Digital por Internet (CFDI) a timbrar codificado en base 64, valida su estructura y retorna el XML del CFDI con el complemento de Timbre Fiscal Digital.
