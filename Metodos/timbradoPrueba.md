...
El método *timbradoPrueba* recibe el XML de un Comprobante Fiscal Digital por Internet (CFDI) realizando todas las validaciones y operación de timbrado, retorna el XML del CFDI con el complemento de Timbre Fiscal Digital, este carece de validez fiscal ya que este no es publicado ante el SAT.
